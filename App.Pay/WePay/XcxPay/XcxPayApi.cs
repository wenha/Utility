...
namespace App.Pay.WePay.XcxPay
{
    public class XcxPayApi
    {
        ...
        */
        public static XcxPayData Micropay(XcxPayData inputObj, int timeOut = 10)
        {
        ...
        */
        public static XcxPayData OrderQuery(XcxPayData inputObj, int timeOut = 6)
        {
        ...
        */
        public static XcxPayData Reverse(XcxPayData inputObj, int timeOut = 6)
        {
            ...
            string response = XcxPayHttpService.Post(xml, url, true, timeOut);
        ...
        */
        public static XcxPayData Refund(XcxPayData inputObj, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static XcxPayData RefundQuery(XcxPayData inputObj, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static XcxPayData DownloadBill(XcxPayData inputObj, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static XcxPayData ShortUrl(XcxPayData inputObj, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static XcxPayData UnifiedOrder(XcxPayData inputObj, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static XcxPayData UnifiedOrderApp(XcxPayData inputObj, int timeOut = 6)
        {
            string url = "https://api.mch.weixin.qq.com/pay/unifiedorder";
            //检测必填参数
            if (!inputObj.IsSet("out_trade_no"))
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static XcxPayData CloseOrder(XcxPayData inputObj, int timeOut = 6)
        {
	    ...
	    */
        public static XcxPayData Report(XcxPayData inputObj, int timeOut = 1)
        {
        ...
        */
        ...
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}", XcxPayConfig.MCHID, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999));
        }
