...
namespace App.Pay.WePay.XcxPay
{
    public class XcxPayConfig : WePayConfig
    {
        ...
        */
        ...
        public static string APPSECRET = WebConfigurationManager.AppSettings["XcxAppSecret"].ToString();
        ...
        */
        public static string NOTIFY_URL = WebConfigurationManager.AppSettings["XcxNotifyUrl"].ToString();
